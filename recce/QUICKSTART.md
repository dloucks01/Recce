...
| **`report.html`** | self-contained client-ready page — visual **At a glance** dashboard (severity donut, machines-by-risk, most-affected systems), exec summary, findings, attack path |
